...
<form class="container mx-auto p-5" method="post" enctype="multipart/form-data">
   ...
   <div class="mb-3">
     ...
     <input name="username" id="username" type="text" class="bg-gray-50 background-blue-400 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
   </div>
   <div mb-3>
    <label for="Content" class="block mb-2 text-sm font-medium text-gray-900">Content</label>
    <textarea name="Content" id="Content" class="bg-gray-50 background-blue-400 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full "></textarea>
  </div>
