...
<div class="container mx-auto">
    ...
    <img class="w-full p-0.5 mx-auto " src="https://picsum.photos/600" alt="Post">
    <div class="text-sm">
        <span class="font-bold">Natures_delight</span>
        <span class="text-gray-700">New Beginnings</span>
    </div>
</div>
